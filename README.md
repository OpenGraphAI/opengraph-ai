...
> **Live sample:** [Robot Scene Memory](https://opengraphai.github.io/opengraph-samples-robot-scene-memory/) turns 16 BridgeData V2 robot-camera observations into a read-only Cytoscape.js graph gallery, with source data and reproduction steps in the [sample repository](https://github.com/OpenGraphAI/opengraph-samples-robot-scene-memory).
